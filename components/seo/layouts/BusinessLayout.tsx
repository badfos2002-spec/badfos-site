  ...
  return (
    <main className="min-h-screen bg-white" dir="rtl">
      ...
      <StatStrip
        ...
        stats={[
          { value: 'מ־37 ₪', label: 'חולצה ממותגת ליחידה — סווטשירט מ־53 ₪' },
          { value: '5%', label: 'הנחת כמות אוטומטית מ־15 יחידות' },
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 md:px-8 md:py-20">
        ...
        <StepsTimeline
          ...
          steps={[
            ...
            {
              title: 'ייצור ואספקה',
              text: 'תוך ימים ספורים: משלוח עד דלת העסק לכל הארץ (35 ₪) או איסוף עצמי חינם מראשון לציון',
            },
          ]}
        />
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 md:px-8 md:pb-24">
        <ChecklistCard
          ...
          items={[
            ...
            'הנחת כמות 5% אוטומטית מ־15 יחידות, וחבילות מוזלות לצוותים גדולים',
