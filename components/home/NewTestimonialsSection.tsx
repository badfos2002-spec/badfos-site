...
// ---------- Solid avatar colors (Google-style) ----------
const AVATAR_COLORS = [
  ...
  return (
    <section className="w-full bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 py-20 overflow-hidden" dir="rtl">
      <div className="mx-auto max-w-[1536px] px-4 md:px-0">
        ...
        {/* Carousel — fixed-height container to prevent CLS */}
        <div className="relative min-h-[320px] md:min-h-[280px] overflow-hidden flex items-start">
          <div
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 items-start w-full transition-all duration-500 ease-in-out ${slideClass}`}
          >
