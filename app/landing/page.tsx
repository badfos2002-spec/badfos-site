...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfcf9] pb-[72px] md:pb-0 overflow-x-hidden" dir="rtl">
      ...
      {/* ═══ VIDEO — mobile only (desktop shows in hero) ═══ */}
      <section className="lg:hidden relative bg-gradient-to-b from-[#fdfcf9] to-[#f5f0e8] py-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-lg font-bold text-gray-900 mb-4">ראו את איכות ההדפסה שלנו</h2>
      ...
      <section ref={formReveal.ref} id="form-section" className="relative max-w-lg lg:max-w-5xl mx-auto px-4 py-10 sm:py-14 scroll-mt-8 overflow-visible">
