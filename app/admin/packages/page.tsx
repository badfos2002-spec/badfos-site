...
// Owner-defined package spec (rev 4, 2026-08-06): quantities, per-unit prices,
// and which package includes the graphic designer.
const PACKAGES_SPEC_REV = 4
const DEFAULT_PACKAGES: Omit<Package, 'id'>[] = [
  ...
  { name: '21-50 חולצות', tag: 'הכי משתלם', minQuantity: 21, maxQuantity: 50, pricePerUnit: 40, graphicDesignerCost: 0, isActive: true, sortOrder: 2, image: '/images/packages/package-21-50.png' },
]
