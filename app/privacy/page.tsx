  ...
  const sections = [
    ...
    },
    {
      ...
      bullets: [
        ...
        'משלוח הודעות תפעוליות בנוגע להזמנה בוואטסאפ, באימייל וב-SMS — לרבות עדכוני הזמנה, תזכורות להשלמת הזמנה והטבות אישיות הקשורות להזמנה',
        'שיפור חוויית השימוש באתר',
        'ניתוח סטטיסטי כללי של תנועת האתר',
      ],
      extra: 'במסירת פרטי התקשרות (טלפון / אימייל) בעת ביצוע הזמנה או פנייה, ובאישור מדיניות זו, מאשר הלקוח לעסק לשלוח לו הודעות תפעוליות בערוצים אלה (וואטסאפ / אימייל / SMS), לרבות עדכוני הזמנה, תזכורות להשלמת הזמנה והטבות אישיות הקשורות להזמנתו. ניתן להסיר עצמכם מקבלת הודעות בכל עת בפנייה אלינו או במענה "הסר" בוואטסאפ. מעבר לכך, אנו לא משתמשים במידע שלכם לצורכי דיוור פרסומי ואיננו שולחים ניוזלטר ללא הסכמה.',
